...
class VisitorTests {
  ...
  @Test
  void interpret() {
    class Env { final HashMap<String, Integer> vars = new HashMap<>();}
  ...
  @Test void registerSameVisitletTwice() {
    assertThrows(IllegalStateException.class, () -> Visitor.create(Void.class, Void.class, opt -> opt
      .register(String.class, (_1, _2, _3) -> null)
      .register(String.class, (_1, _2, _3) -> null)
    ));
  }
  
  @Test void visitCanNotFindAVisitlet() {
    Visitor<Void,Void> visitor = Visitor.create(Void.class, Void.class, opt -> {});
    assertThrows(IllegalStateException.class, () -> visitor.visit("oops", null));
  }

  @Test void nullWhenCreatingAVisitor1() { assertThrows(NullPointerException.class, () -> Visitor.create(null, Void.class, opt -> {})); }
  @Test void nullWhenCreatingAVisitor2() { assertThrows(NullPointerException.class, () -> Visitor.create(Void.class, null, opt -> {})); }
  @Test void nullWhenCreatingAVisitor3() { assertThrows(NullPointerException.class, () -> Visitor.create(Void.class, Void.class, null)); }
  
  @Test
  void nullWhenCallingVisit() {
    Visitor<String, Void> visitor = Visitor.create(String.class, Void.class, opt -> {});
